...
- **Authentication** — Argon2 password hashing, SHA-256 hashed session tokens, configurable session expiry
...
- **Database** — SQLite with parameterized queries (no raw string interpolation)
