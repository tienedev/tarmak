...
- **Single binary** — Rust server embeds frontend, serves API, WebSocket, and MCP
- **SQLite** — WAL mode, auto-migrations, zero external dependencies
- **Docker** — multi-stage Alpine build, published to ghcr.io
- **CLI** — backup, restore, export, import, user management, password reset
- **CI/CD** — GitHub Actions for format, lint, test, E2E, Docker publish
